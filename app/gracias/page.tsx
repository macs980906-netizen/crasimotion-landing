...
export const metadata: Metadata = {
  ...
  description:
    "Tu lugar en el webinar privado de Cosecha Capital ha quedado registrado. Revisa tu correo para los detalles de acceso.",
      ...
      <main className="flex flex-1 items-center justify-center overflow-hidden bg-forest-950 px-5 py-24 sm:py-32">
        ...
        <div className="relative mx-auto w-full max-w-xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-md text-base leading-relaxed text-cream-100/70">
            Gracias por reservar tu lugar en el webinar privado de Cosecha
            Capital. Revisa tu correo: ahí encontrarás los detalles de acceso y
            la confirmación de tu participación.
          </p>
